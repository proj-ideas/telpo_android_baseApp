...
//            dbResult = capkdbDao.create(capkdb);
    ...
    public static void Add_All_CAPK(){
        ...
        capk.Modul = ISOUtil.hex2byte("B3E5E667506C47CAAFB12A2633819350846697DD65A796E5CE77C57C626A66F70BB630911612AD2832909B8062291BECA46CD33B66A6F9C9D48CED8B4FC8561C8A1D8FB15862C9EB60178DEA2BE1F82236FFCFF4F3843C272179DCDD384D541053DA6A6A0D3CE48FDC2DC4E3E0EEE15F");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("FE70AB3B4D5A1B9924228ADF8027C758483A8B7E");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("D0135CE8A4436C7F9D5CC66547E30EA402F98105B71722E24BC08DCC80AB7E71EC23B8CE6A1DC6AC2A8CF55543D74A8AE7B388F9B174B7F0D756C22CBB5974F9016A56B601CCA64C71F04B78E86C501B193A5556D5389ECE4DEA258AB97F52A3");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("86DF041E7995023552A79E2623E49180C0CD957A");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("F934FC032BE59B609A9A649E04446F1B365D1D23A1E6574E490170527EDF32F398326159B39B63D07E95E6276D7FCBB786925182BC0667FBD8F6566B361CA41A38DDF227091B87FA4F47BAC780AC47E15A6A0FB65393EB3473E8D193A07EB579");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("A0DF5DAA385AE3E0E21BFD34D9D8A30506B19B12");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("1FF80A40173F52D7D27E0F26A146A1C8CCB29046");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("833B1947778036B6D759FCE3F618DDEB2749372C");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("7AC3D80EF01E9A998F0A77181E64B36747DC51EB");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("");
        capk.Exponent = new byte[]{0x11};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("B769775668CACB5D22A647D1D993141EDAB7237B");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("BBE43877CC28C0CE1E14BC14E8477317E218364531D155BB8AC5B63C0D6E284DD24259193899F9C04C30BAF167D57929451F67AEBD3BBD0D41444501847D8F02F2C2A2D14817D97AE2625DC163BF8B484C40FFB51749CEDDE9434FB2A0A41099");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("D3D90B35BA8C48731171EAC407D89005ACF6F9DA");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("");
        capk.Exponent = new byte[]{0x11};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("73A7CA6BA7DB3C37B78E86952BC4EC7754925D54");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("A84A53964513A5D9363B4BA13AF5D43B83A83CE7");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        capk = new EmvCAPK();
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("");
        capk.Exponent = new byte[]{0x11};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("E6D302EBE7DC6F267E4D00F7D488F0AB6235F105");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("7616E9AC8BE014AF88CA11A8FB17967B7394030E");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("AF0754EAED977043AB6F41D6312AB1E22A6809175BEB28E70D5F99B2DF18CAE73519341BBBD327D0B8BE9D4D0E15F07D36EA3E3A05C892F5B19A3E9D3413B0D97E7AD10A5F5DE8E38860C0AD004B1E06F4040C295ACB457A788551B6127C0B29");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("8001CA76C1203955E2C62841CD6F201087E564BF");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("CA026E52A695E72BD30AF928196EEDC9FAF4A619F2492E3FB31169789C276FFBB7D43116647BA9E0D106A3542E3965292CF77823DD34CA8EEC7DE367E08070895077C7EFAD939924CB187067DBF92CB1E785917BD38BACE0C194CA12DF0CE5B7A50275AC61BE7C3B436887CA98C9FD39");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("E7AC9AA8EED1B5FF1BD532CF1489A3E5557572C1");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        capk = new EmvCAPK();
        ...
        capk.HashInd = (byte) 0x01;
        capk.ArithInd = (byte) 0x01;
        capk.Modul = ISOUtil.hex2byte("");
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("4ABFFD6B1C51212D05552E431C5B17007D2F5E6D");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
        capk = new EmvCAPK();
        ...
        capk.Exponent = new byte[]{0x03};
        capk.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk.CheckSum = ISOUtil.hex2byte("128EB33128E63E38C9A83A2B1A9349E178F82196");
        result = EmvService.Emv_AddCapk(capk);
        Log("Add CAPK capk_D1:" + result + " ID:" + capk.KeyID + "RID:"+ ISOUtil.hexString(capk.RID));
        //==================================================
    ...
    static void addPaypassCAPK() {
        ...
        Log("add Capk " + ISOUtil.hexString(capk_01.RID) + "(" + Integer.toHexString(capk_01.KeyID) + ")" + " : " + result);
        ...
        capk_01.HashInd = (byte) 0x01;
        capk_01.ArithInd = (byte) 0x01;
        capk_01.Modul = ISOUtil.hex2byte("967B6264436C96AA9305776A5919C70DA796340F9997A6C6EF7BEF1D4DBF9CB4289FB7990ABFF1F3AE692F12844B2452A50AE075FB327976A40E8028F279B1E3CCB623957D696FC1225CA2EC950E2D415E9AA931FF18B13168D661FBD06F0ABB");
        capk_01.Exponent = new byte[]{0x03};
        capk_01.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk_01.CheckSum = ISOUtil.hex2byte("1D90595C2EF9FC6E71B0C721118333DF8A71FE21");
        result = EmvService.Emv_AddCapk(capk_01);
        Log("add Capk " + ISOUtil.hexString(capk_01.RID) + "(" + Integer.toHexString(capk_01.KeyID) + ")" + " : " + result);
        ...
        capk_01.HashInd = (byte) 0x01;
        capk_01.ArithInd = (byte) 0x01;
        capk_01.Modul = ISOUtil.hex2byte("BBE43877CC28C0CE1E14BC14E8477317E218364531D155BB8AC5B63C0D6E284DD24259193899F9C04C30BAF167D57929451F67AEBD3BBD0D41444501847D8F02F2C2A2D14817D97AE2625DC163BF8B484C40FFB51749CEDDE9434FB2A0A41099");
        capk_01.Exponent = new byte[]{0x03};
        capk_01.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk_01.CheckSum = ISOUtil.hex2byte("008C39B1D119498268B07843349427AC6E98F807");
        result = EmvService.Emv_AddCapk(capk_01);
        Log("add Capk " + ISOUtil.hexString(capk_01.RID) + "(" + Integer.toHexString(capk_01.KeyID) + ")" + " : " + result);
        ...
        capk_01.HashInd = (byte) 0x01;
        capk_01.ArithInd = (byte) 0x01;
        capk_01.Modul = ISOUtil.hex2byte("");
        capk_01.Exponent = new byte[]{0x11};
        capk_01.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk_01.CheckSum = ISOUtil.hex2byte("DEB81EDB2626A4BB6AE23B77D19A77539D0E6716");
        result = EmvService.Emv_AddCapk(capk_01);
        Log("add Capk " + ISOUtil.hexString(capk_01.RID) + "(" + Integer.toHexString(capk_01.KeyID) + ")" + " : " + result);
        ...
        capk_01.HashInd = (byte) 0x01;
        capk_01.ArithInd = (byte) 0x01;
        capk_01.Modul = ISOUtil.hex2byte("");
        capk_01.Exponent = new byte[]{0x03};
        capk_01.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk_01.CheckSum = ISOUtil.hex2byte("AE667445F8DE6F82C38800E5EBABA322F03F58F2");
        result = EmvService.Emv_AddCapk(capk_01);
        Log("add Capk " + ISOUtil.hexString(capk_01.RID) + "(" + Integer.toHexString(capk_01.KeyID) + ")" + " : " + result);
        ...
        capk_01.HashInd = (byte) 0x01;
        capk_01.ArithInd = (byte) 0x01;
        capk_01.Modul = ISOUtil.hex2byte("");
        capk_01.Exponent = new byte[]{0x02};
        capk_01.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk_01.CheckSum = ISOUtil.hex2byte("6C7289632919ABEE6E1163D7E6BF693FD88EBD35");
        result = EmvService.Emv_AddCapk(capk_01);
        Log("add Capk " + ISOUtil.hexString(capk_01.RID) + "(" + Integer.toHexString(capk_01.KeyID) + ")" + " : " + result);
        ...
        capk_01.HashInd = (byte) 0x01;
        capk_01.ArithInd = (byte) 0x01;
        capk_01.Modul = ISOUtil.hex2byte("B37BFD2A9674AD6221C1A001081C62653DC280B0A9BD052C677C913CE7A0D902E77B12F4D4D79037B1E9B923A8BB3FAC3C612045BB3914F8DF41E9A1B61BFA5B41705A691D09CE6F530FE48B30240D98F4E692FFD6AADB87243BA8597AB237586ECF258F4148751BE5DA5A3BE6CC34BD");
        capk_01.Exponent = new byte[]{0x02};
        capk_01.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk_01.CheckSum = ISOUtil.hex2byte("7FB377EEBBCF7E3A6D04015D10E1BDCB15E21B80");
        result = EmvService.Emv_AddCapk(capk_01);
        Log("add Capk " + ISOUtil.hexString(capk_01.RID) + "(" + Integer.toHexString(capk_01.KeyID) + ")" + " : " + result);
        ...
        capk_01.HashInd = (byte) 0x01;
        capk_01.ArithInd = (byte) 0x01;
        capk_01.Modul = ISOUtil.hex2byte("B3572BA49AE4C7B7A0019E5189E142CFCDED9498DDB5F0470567AB0BA713B8DA226424622955B54B937ABFEFAAD97919E377621E22196ABC1419D5ADC123484209EA7CB7029E66A0D54C5B45C8AD615AEDB6AE9E0A2F75310EA8961287241245");
        capk_01.Exponent = new byte[]{0x02};
        capk_01.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk_01.CheckSum = ISOUtil.hex2byte("23CF0D702E0AEFE518E4FA6B836D3CD45B8AAA71");
        result = EmvService.Emv_AddCapk(capk_01);
        Log("add Capk " + ISOUtil.hexString(capk_01.RID) + "(" + Integer.toHexString(capk_01.KeyID) + ")" + " : " + result);
        ...
        capk_01.HashInd = (byte) 0x01;
        capk_01.ArithInd = (byte) 0x01;
        capk_01.Modul = ISOUtil.hex2byte("B855CC64313AF99C453D181642EE7DD21A67D0FF50C61FE213BCDC18AFBCD07722EFDD2594EFDC227DA3DA23ADCC90E3FA907453ACC954C47323BEDCF8D4862C457D25F47B16D7C3502BE081913E5B0482D838484065DA5F6659E00A9E5D570ADA1EC6AF8C57960075119581FC81468D");
        capk_01.Exponent = new byte[]{0x03};
        capk_01.ExpDate = new byte[]{0x25, 0x12, 0x31};
        capk_01.CheckSum = ISOUtil.hex2byte("B4E769CECF7AAC4783F305E0B110602A07A6355B");
        result = EmvService.Emv_AddCapk(capk_01);
        Log("add Capk " + ISOUtil.hexString(capk_01.RID) + "(" + Integer.toHexString(capk_01.KeyID) + ")" + " : " + result);
